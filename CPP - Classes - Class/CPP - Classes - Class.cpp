...
public:
    Student()
        ...
        {        }
    Student(const int& age, const std::string& first_name,
                            const std::string& last_name, const int& standard)
    ...
    void set_first_name(const std::string& first_name)  {   this->m_first_name = first_name;    }
    void set_last_name(const std::string& last_name)    {   this->m_last_name = last_name;      }
    ...
    const std::string& get_last_name()const  { return m_last_name; }
